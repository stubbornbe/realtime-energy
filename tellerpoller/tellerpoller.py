...
# Altered by Dita StubbornBE for JSON output and enery import
import serial
import socket
import sys
...
#    "1-0:71.7.0": "L3 current",
    ...
    "1-0:1.6.0": "Maximum demand active energy import curr month",
    "1-0:1.4.0": "Current avg demand active energy import"
    }
        ...
        try:
            ...
            if "!" in p1line.decode('ascii'):
                ...
                if checkcrc(p1telegram):
                    ...
                    with open('tellerdata.json', 'w') as filehandle:
                        json.dump(output, filehandle)
                    #message=["message":output] 
                    UDP_IP = "logger.daxus.local"
                    UDP_PORT = 9995
                    #json.dump(output,MESSAGE) 
